        ...
        <div className="global-header">
            ...
            <div className="gh-left">
                <div className="gh-logo-box" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <img src="/icons/logo.png" alt="MemoryHub Logo" style={{ height: 36, width: 'auto', objectFit: 'contain', display: 'block' }} />
                </div>
                <div className="gh-app-name" style={{ fontFamily: 'Impact, sans-serif', fontSize: 24, letterSpacing: 0.5, userSelect: 'none', marginLeft: 8 }}>
